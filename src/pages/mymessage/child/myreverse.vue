...
export default{
  ...
  methods:{
      initNewData(){
         let   self=this;
          this.$ajax.post("get/newbyreverse",{location: self.location,number: self.number},function(userdata){   
  ...
  bottom: false
       ...
       let   self=this;
           self.scroll.on('touchEnd', (pos) => {
                ...
                if (pos.y > 30) {
                  ...
                  console.log("sss");
               //刷新
                  self.$ajax.post("get/newbyreverse",{location:0,number:self.number},function(userdata){ 
   ...
   self.$ajax.post("get/newbyreverse",{location: self.location,number: self.number},function(userdata){   
